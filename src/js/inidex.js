function initCanvas(){
    ...
    function reduceScore() {
        setInterval(() => {
            ...
            if(contador < 0)
            {
                alert("OH NOOO, has dejado que se te acabe el helio tendras que empezar el juego de nuevo. Presiona OK")
                location.reload();
            }
            if(contador == 500)
            {
                alert("Has defendido la alxia exitosamente, pasas al siguiente nivel")
                location.reload();
            }
        }, 10000);
    ...
    var stageWidth = 700;
    var stageHeight = 350;
    var intervalInMilliseconds = 1800;
    var enemies = [
    ];  
    var enemyWidth = 100;
    var enemyHeight = 50;
    ...
    var intervalInMilliseconds2 = 750;
    var enemies2 = [
    ];  
    var enemyWidth2 = 100;
    var enemyHeight2 = 50;
...
// aqui se renderizan los enemigos para que puedan aparecer
    var renderEnemies = function(enemyList, enemyList2) {
        ...
        for(var i=0; i<enemyList.length; i++) {
            ...
            ctx.drawImage(enemy.image, enemy.x, enemy.y -= 1.2, enemy.w, enemy.h);
            ctx.drawImage(enemy2.image, enemy2.x, enemy2.y -= .6, enemy2.w, enemy2.h);
        }
    }
        ...
        this.render = function() 
        {
            ...
            if (naveImage.src = "src/assets/img/Explosion.jpg")
            {
                                    ...
                                    if(this.gameStatus.over === true)
                                    {
                                        ...
                                        alert("OOPS, la nave se ha estrellado debera de empezar el juego de nuevo. Presione OK")
                                        location.reload();                                    }
                                }
                }
